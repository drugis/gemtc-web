...
/*global console: false, MozWebSocket: false, CryptoJS: false , freeze:true*/
/* jshint freeze:true */

define(['gemtc-web/lib/when'], function(when) {
  /** @define {string} */
  ...
  ab.Session = function(wsuri, onopen, onclose, options) {
    ...
    self._websocket.onerror = function() {
