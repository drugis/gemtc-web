...
--rollback ALTER TABLE DROP CONSTRAINT funnelplot_modelid_fkey;
--rollback ALTER TABLE modelBaseline DROP CONSTRAINT modelbaseline_modelid_fkey;
--rollback ALTER TABLE modelBaseline ADD CONSTRAINT FOREIGN KEY (modelId) REFERENCES model(id);
--rollback ALTER TABLE model DROP CONSTRAINT model_analysisid_fkey;
--rollback ALTER TABLE model ADD CONSTRAINT FOREIGN KEY (analysisId) REFERENCES analysis(id);
--rollback COMMIT;
